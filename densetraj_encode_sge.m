...
%% kf_dir_name: name of keyframe folder, e.g. keyframe-60 for segment length of 60s   
	...
	feature_ext_fc = sprintf('idensetraj.mbh.cb%d.fc', codebook_gmm_size);
	if dimred > 0,
		feature_ext_fc = sprintf('idensetraj.mbh.cb%d.fc.pca', codebook_gmm_size);
	end
	...
	%codebook_hoghof_file = sprintf('/home/ntrang/project/output/feature/bow.codebook.devel/idensetraj.hoghof/data/codebook.gmm.%d.mat', codebook_gmm_size);
	%codebook_mbh_file = sprintf('/home/ntrang/project/output/hmdb51/feature/bow.codebook.devel/idensetraj.mbh/data/codebook.gmm.%d.mat', codebook_gmm_size);
	%low_proj = [];
	...
	codebook_mbh_file = sprintf('/home/ntrang/project/output/hmdb51/feature/bow.codebook.devel/idensetraj.mbh/data/codebook.gmm.%d.%d.mat', codebook_gmm_size, 192);
