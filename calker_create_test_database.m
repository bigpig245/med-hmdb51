function calker_create_test_database()
	dataset_dir = '/home/ntrang/project/dataset/hmdb51';
	
	meta_file = '/home/ntrang/project/output/hmdb51/metadata/metadata_test.mat';
	...
	for i = 1:length(events),
		...
		log(sprintf('Create test info for event: %s', event_name));
...
function log (msg)
	fh = fopen('/home/ntrang/project/logs/hmdb51/calker_create_test_database.log', 'a+');
