function pcode = sift_encode_spm(enc_type, imsize, frames, feats, codebook, kdtree, low_proj)
    ...
    low_proj_file = '/home/ntrang/project/output/hmdb51/feature/bow.codebook.devel/idensetraj.mbh/data/lowproj.training.128.192.mat';
    load(low_proj_file, 'low_proj');
