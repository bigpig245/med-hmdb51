...
%   Detailed explanation goes here
	...
	% densetraj = '/home/ntrang/tools/dense_trajectory_release/release/DenseTrack_FULL';
	% densetraj = '/home/ntrang/software/dense_trajectory_release_v1.1/release/DenseTrack';
	% densetraj = '/home/ntrang/tools/dense_trajectory_release/release/DenseTrack';  % same with DenseTrack_FULL
	% densetraj = '/home/ntrang/tools/dense_trajectory_release/release/DenseTrack_MBH';
	
	% switch dt_type,
		% case 'dt'
			% densetraj = '/home/ntrang/tools/dense_trajectory_release/release/DenseTrack_MBH';
		% case 'idt'
			% densetraj = 'LD_PRELOAD=/home/ntrang/usr.local/lib/libstdc++.so /home/ntrang/tools/improved_trajectory_release/release/DenseTrackStab_MBH';
		% otherwise
			% error('Unsupported Dense Trajectory Type\n');
	% end
	
	densetraj = 'LD_PRELOAD=/home/ntrang/usr.local/lib/libstdc++.so /home/ntrang/tools/improved_trajectory_release/release/DenseTrackStab_HOGHOFMBH';
