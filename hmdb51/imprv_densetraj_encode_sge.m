...
%% kf_dir_name: name of keyframe folder, e.g. keyframe-60 for segment length of 60s   
	...
	feature_ext_fc = sprintf('imprvdensetraj.mbh.cb%d.fc', codebook_gmm_size);
	if dimred > 0,
		feature_ext_fc = sprintf('imprvdensetraj.mbh.cb%d.fc.pca', codebook_gmm_size);
	end
	...
	codebook_file = sprintf('/home/ntrang/project/output/hmdb51/feature/bow.codebook.devel/imprvdensetraj.mbh/data/codebook.gmm.%d.%d.mat', codebook_gmm_size, 192);
	low_proj_file = sprintf('/home/ntrang/project/output/hmdb51/feature/bow.codebook.devel/imprvdensetraj.mbh/data/lowproj.%d.%d.mat', dimred, 192);
	codebook_ = load(codebook_file, 'codebook');
	codebook = codebook_.codebook;ghof_.low_proj;
