function [ feats ] = imprv_densetraj_select_features(descriptor, max_features )
...
%Detailed explanation goes here
	...
	for i = 1:length(metadata.videos),
		...
		feat = imprv_densetraj_extract_features(video_file, descriptor);
	...
	output_file = sprintf('/home/ntrang/project/output/hmdb51/feature/bow.codebook.devel/imprvdensetraj.%s/data/selected_feats_%d.mat', descriptor, max_features);
