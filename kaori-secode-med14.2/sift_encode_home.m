...
%% kf_dir_name: name of keyframe folder, e.g. keyframe-60 for segment length of 60s   
    ...
    fea_dir = sprintf('/home/ntrang/%s/feature/%s', proj_name, kf_dir_name);
	...
	codebook_file = sprintf('/home/ntrang/%s/feature/bow.codebook.%s.devel/%s.%s.sift/data/codebook.%d.mat', proj_name, proj_name, sift_algo, num2str(param), codebook_size);
	...
	kf_dir = sprintf('/home/ntrang/%s/keyframes/%s', proj_name, szPat);
