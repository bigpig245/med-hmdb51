...
%% kf_dir_name: name of keyframe folder, e.g. keyframe-60 for segment length of 60s   
	...
	video_dir = '/home/ntrang/dataset/MED2013/LDCDIST';	% for mfcc 
	fea_dir = '/home/ntrang/trecvidmed13/feature';
	%f_metadata = sprintf('/home/ntrang/trecvidmed13/metadata/common/metadata_%s_sorted', sz_pat);
	...
	if dimred > 0,
		codebook_gmm_file = sprintf('/home/ntrang/trecvidmed13/feature/bow.codebook.devel/mfcc.bg.%s/data/codebook.gmm.%d.%d.mat', algo, codebook_gmm_size, dimred);
		low_proj_file = sprintf('/home/ntrang/trecvidmed13/feature/bow.codebook.devel/mfcc.bg.%s/data/lowproj.%d.%d.mat', algo, dimred, feat_dim);
		low_proj_ = load(low_proj_file, 'low_proj');
		low_proj = low_proj_.low_proj;
	else
		codebook_gmm_file = sprintf('/home/ntrang/trecvidmed13/feature/bow.codebook.devel/mfcc.bg.%s/data/codebook.gmm.%d.%d.mat', algo, codebook_gmm_size, feat_dim);
