...
%   Detailed explanation goes here
	...
	f_seg_meta = sprintf('/home/ntrang/trecvidmed13/metadata/%s/segments.%s.mat', segment_ann, sz_pat);
	...
	videolst = sprintf('/home/ntrang/trecvidmed13/metadata/common/trecvidmed13.%s.lst', sz_pat);
    ...
    for ii = 1:length(videos),
		...
		if strcmp(sz_pat, 'dev'),
			mfile = sprintf('/home/ntrang/trecvidmed13/metadata/%s/%s/%s.lst', segment_ann, 'devel', video);
		else
			mfile = sprintf('/home/ntrang/trecvidmed13/metadata/%s/%s/%s.lst', segment_ann, sz_pat, video);
		end
