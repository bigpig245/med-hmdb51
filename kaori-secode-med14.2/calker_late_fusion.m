function calker_late_fusion(proj_name, test_pat, suffix)
	...
	ker.proj_dir = '/home/ntrang';
	
	addpath('/home/ntrang/tools/kaori-secode-calker/support');
	addpath('/home/ntrang/tools/libsvm-3.17/matlab');
	addpath('/home/ntrang/tools/vlfeat-0.9.16/toolbox');

	event_list = '/home/ntrang/trecvidmed13/metadata/common/trecvidmed13.events.ps.lst';
