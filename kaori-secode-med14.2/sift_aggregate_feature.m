...
%% kf_dir_name: name of keyframe folder, e.g. keyframe-60 for segment length of 60s   
    ...
    fea_dir = sprintf('/home/ntrang/trecvidmed13/feature/%s', segment_ann);	
	...
	output_kf_feat_dir = sprintf('/home/ntrang/trecvidmed13/feature/keyframes/%s/%s', feature_ext, szPat) ;
    ...
    %tic
	f_metadata = sprintf('/home/ntrang/trecvidmed13/metadata/common/metadata_%s.mat', szPat);
...
function log (msg)
	fh = fopen('/home/ntrang/tools/kaori-secode-med13/log/sift_aggregate_feature.log', 'a+');
