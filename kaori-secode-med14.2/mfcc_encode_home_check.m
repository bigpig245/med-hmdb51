...
%% kf_dir_name: name of keyframe folder, e.g. keyframe-60 for segment length of 60s   
	...
	f_metadata = sprintf('/home/ntrang/trecvidmed13/metadata/common/metadata_%s', sz_pat);
    ...
    codebook_file = sprintf('/home/ntrang/trecvidmed13/feature/bow.codebook.devel/mfcc.%s/data/codebook.kmeans.%d.%d.mat', algo, codebook_size, feat_dim);
	...
	codebook_gmm_file = sprintf('/home/ntrang/trecvidmed13/feature/bow.codebook.devel/mfcc.%s/data/codebook.gmm.%d.%d.mat', algo, codebook_gmm_size, feat_dim);
