...
%   Detailed explanation goes here
	...
	video_dir = '/home/ntrang/dataset/MED2013/LDCDIST';
	
	feat_pat = sprintf('mfcc.bg.%s', algo');

	output_file = sprintf('/home/ntrang/trecvidmed13/feature/bow.codebook.devel/%s/data/selected_feats_%d.mat', feat_pat, max_features);
	...
	% csv_dir = '/home/ntrang/dataset/MED2013/MEDDATA/databases';
