...
%% kf_dir_name: name of keyframe folder, e.g. keyframe-60 for segment length of 60s   
	...
	video_dir = '/home/ntrang/dataset/MED2013/LDCDIST-RSZ';
	fea_dir = '/home/ntrang/trecvidmed13/feature';
	
	f_metadata = sprintf('/home/ntrang/trecvidmed13/metadata/common/metadata_devel.mat');  % for kinddevel only
	...
	codebook_hoghof_file = sprintf('/home/ntrang/trecvidmed13/feature/bow.codebook.devel/idensetraj.hoghof/data/codebook.gmm.%d.mat', codebook_gmm_size);
	codebook_mbh_file = sprintf('/home/ntrang/trecvidmed13/feature/bow.codebook.devel/idensetraj.mbh/data/codebook.gmm.%d.mat', codebook_gmm_size);
	low_proj = [];
	
	
	codebook_hoghof_file = sprintf('/home/ntrang/trecvidmed13/feature/bow.codebook.devel/idensetraj.hoghof/data/codebook.gmm.%d.%d.mat', codebook_gmm_size, dimred);
	low_proj_hoghof_file = sprintf('/home/ntrang/trecvidmed13/feature/bow.codebook.devel/idensetraj.hoghof/data/lowproj.%d.%d.mat', dimred, 204);
	
	codebook_mbh_file = sprintf('/home/ntrang/trecvidmed13/feature/bow.codebook.devel/idensetraj.mbh/data/codebook.gmm.%d.%d.mat', codebook_gmm_size, dimred);
	low_proj_mbh_file = sprintf('/home/ntrang/trecvidmed13/feature/bow.codebook.devel/idensetraj.mbh/data/lowproj.%d.%d.mat', dimred, 192);
