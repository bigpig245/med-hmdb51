...
%   Detailed explanation goes here
	...
	output_file = sprintf('/home/ntrang/trecvidmed13/feature/bow.codebook.devel/densetrajectory.%s/data/codebook.kmeans.%d.mat', descriptor, cluster_count);
	if exist(output_file, 'file'),
		fprintf('File [%s] already exists. skipped!\n', output_file);
		return;
	end
	
	selected_feat_file = sprintf('/home/ntrang/trecvidmed13/feature/bow.codebook.devel/densetrajectory.%s/data/selected_feats_%d_%d.mat', descriptor, max_features);
